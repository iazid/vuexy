...
const EditEventPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setLoading(false);
      router.push('/eventtest/eventpage');
    }
  };
        ...
        <Box component='form' onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-6'>
          ...
          {imagePreview && (
            <Box sx={{ position: 'relative', display: 'inline-block' }}>
              <img src={imagePreview} alt="Aperçu de l'événement" style={{ maxWidth: '400px', maxHeight: '400px', marginTop: '16px', marginBottom: '16px', objectFit: 'contain' }} />
              <IconButton
                sx={{ position: 'inherit', top: 8, right: 8, background: 'rgba(255, 255, 255, 0.7)' }}
          ...
          <Box display="flex" justifyContent="space-between">
            ...
            <Button variant='tonal' color='error' type='reset' onClick={() => router.push('/eventtest/eventpage')}>
              Annuler
            </Button>
          </Box>
        </Box>
